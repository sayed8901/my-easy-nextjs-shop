        ...
        <div className="space-y-3 xl:space-y-5 order-1 md:order-2 pb-10 md:pb-0">
          <div className="space-y-3 xl:space-y-5 mb-5">
            ...
            <p className="text-base xl:text-sm">
              ...
              and self expectation. It had been
              deeply appreciated by its customers because of good words of mouth
              and unique customized service originated from Taiwan.
            </p>
          </div>
